-- ====================================================
-- 1. Insert Users to Core (ON CONFLICT DO NOTHING)
-- ====================================================
...
-- ====================================================
-- 2. Insert Users to Implementation
-- ====================================================
...
-- ====================================================
-- 3. Insert Passwords (hashed untuk '123456')
-- ====================================================
...
INSERT INTO auth_role_impl (id,name,allowedPermissions) VALUES ('75f6727e-66f8-484f-b77f-83eeec82cd10','Administrator','administrator,CreateEventCreation,UpdateEventCreation,DeleteEventCreation,CreateTypeEventCreation,UpdateTypeEventCreation,DeleteTypeEventCreation') ON CONFLICT DO NOTHING;
